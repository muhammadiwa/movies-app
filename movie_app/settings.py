...
SECRET_KEY = 'django-insecure-n8d1i^m0q3&21y1m+0@wx5qw6qnj67)#vwij8y5&!b(9%c-@y9'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'static']  # Ensure this points to the correct static directory
